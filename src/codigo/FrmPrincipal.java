...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnArchivo.setForeground(new java.awt.Color(0, 153, 204));
        ...
        btnAnalizarLex.setBackground(new java.awt.Color(102, 204, 255));
        ...
        jLabel1.setText("             COMPILADOR: Dulce B. Santiago Nicio");

        btnLimpiarLex.setBackground(new java.awt.Color(102, 204, 255));
        ...
        jPanel1.getAccessibleContext().setAccessibleDescription("Compilador Dulce Santiago");
